...
urlpatterns = [
   ...
   path('representations/<int:pk>/availability/', representations.RepresentationsAvailabilityView.as_view(), name='representations-availability'),
    ...
    # PRICES
    path('prices/', prices.PriceListCreateView.as_view(), name='prices-list-create'),
    path('prices/<int:pk>/', prices.PriceRetrieveUpdateDestroyView.as_view(), name='prices-detail'), 
