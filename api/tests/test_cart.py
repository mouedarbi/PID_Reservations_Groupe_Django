...
class CartAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        # --- Required catalogue objects (robust creation) ---
        ...
        # IMPORTANT: The 'Representation' model does not have a 'price' field.
        # For this test to work with the CartItemAddUpdateView, we are mocking
        # a 'price' attribute on the Representation object.
        # Ensure your view logic fetches the price from its actual source.
        ...
        # Mocking the price on the representation object for this test
        self.representation.price = decimal.Decimal('25.00')

        # Another representation for testing multiple items
        ...
        self.representation_2.price = decimal.Decimal('30.00')
    ...
    def test_add_item_to_cart_and_sets_price(self):
        ...
        self.assertEqual(cart_item.price_per_item, self.representation.price)
    ...
    def test_get_cart_item_detail(self):
        ...
        url = reverse("api:cart-item-detail", kwargs={"pk": item_id})
    ...
    def test_user_cannot_access_other_user_cart_item(self):
        ...
        other_item = CartItem.objects.create(
            ...
            quantity=1,
            price_per_item=self.representation.price
        )
    ...
    def test_cart_totals_are_correct(self):
        ...
        expected_total_price = (2 * self.representation.price) + (1 * self.representation_2.price)
